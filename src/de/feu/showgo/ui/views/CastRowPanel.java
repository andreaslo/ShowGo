...
/**
 * This class represents a row in a role/cast assignment. It shows a role name
 * and a combobox with the available persons. Several persons may be assigned to
 * a role.
 */
public class CastRowPanel extends JPanel {
	...
	/**
	 * Instantiates a new cast row panel.
	 *
	 * @param role the role
	 * @param availablePersons the available persons
	 * @param mayBeEmpty the may be empty
	 */
